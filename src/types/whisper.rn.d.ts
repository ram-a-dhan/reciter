/**
 * Pulled from the package's index.d.ts because the package has typescript issues when being imported
 */

declare module 'whisper.rn' {
  // Internal types from NativeRNWhisper
  ...
  export type VadOptions = any;
  export type VadSegment = any;
  export type NativeWhisperContext = any;
  export type NativeWhisperVadContext = any;

  // Internal types from AudioSessionIos
  export type AudioSessionCategoryIos = any;
  export type AudioSessionCategoryOptionIos = any;
  export type AudioSessionModeIos = any;
  export type AudioSessionIos = any;
